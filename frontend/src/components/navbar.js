        ...
        <div className="navigation">
            <Stack spacing={2} direction="column">
                <Button component={Link} to={"/closet"}
                    ...
                    variant="contained"><img src="/icons/icons8-home-logo.svg"></img> Home </Button>

                <Button component={Link} to={"/model"}
                    className={location.pathname === isActive('/model') ? 'active' : 'inactive'}
                    variant="contained"><img src="/icons/icons8-user-50.png"></img> Model </Button>

                <Button component={Link} to={"/search"}
                    className={location.pathname === isActive('/search') ? 'active' : 'inactive'}
                    variant="contained"><img src="/icons/icons8-search.svg"></img> Search</Button>

                <Button component={Link} to={"/profile"}
                    className={location.pathname === isActive('/profile') ? 'active' : 'inactive'}
                    variant="contained"><img src="/icons/icons8-cog.svg"></img> Profile</Button>
            </Stack>
        </div>
    );
}
